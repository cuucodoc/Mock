	...
	<div class="right_col" role="main">
		<div class="jumbotron"
			...
			<div class="x_content well">
				<h1>Thêm mới đặt sân</h1>
				<div class="container">
					<br>
					<html:form action="/themDatSan" method="post">
							...
							<div class="col-lg-3">
								<html:select property="maSan" styleClass="form-control">
									<html:optionsCollection name="datSanForm"
										property="listSan" label="maSan" value="maSan" />
								</html:select>
							</div>
						</div>
						<div class="row form-group">
							...
							<div class="col-lg-3">
								<html:select property="tenDangNhap" styleClass="form-control">
									<html:optionsCollection name="datSanForm"
